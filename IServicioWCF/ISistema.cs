...
namespace com.msc.services.interfaces
{
    ...
    public partial interface ISistema
    {
        ...
        */
        ...
        /// <returns></returns>
        [OperationContract]
        List<wcf.entities.Sistema.TareaDTO> ObtTarea();
        ...
        /// <returns></returns>
        [OperationContract(Name = "ObtTareaxId")]
        wcf.entities.Sistema.TareaDTO ObtTarea(int Id);
        ...
        /// <returns></returns>
        [OperationContract]
        wcf.entities.RespuestaDTO EditTarea(wcf.entities.Sistema.TareaDTO obj);
        ...
        /// <returns></returns>
        [OperationContract]
        wcf.entities.RespuestaDTO ElimTarea(int Id);
        #endregion
    }
}